<?php 
$headercs = "<h3>&nbsp;</h3><h3>AREÁL HORIMEX a HORIMEX CARS I BMW OLOMOUC</h3>";
		
$textcs = "	<div class='detail'>
	<div>místo stavby <span class='red'>|</span> Holice u Olomouce</div>
	<div>investor <span class='red'>|</span> HORIMEX s.r.o., Horimex cars s.r.o. I BMW Olomouc</div>
	<div>autor <span class='red'>|</span> Polách, Bravenec</div>
	<div>projekt <span class='red'>|</span> Atelier Polách & Bravenec s.r.o. 2009-11</div>
