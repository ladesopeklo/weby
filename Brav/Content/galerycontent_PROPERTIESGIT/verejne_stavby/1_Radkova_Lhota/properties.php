<?php 
$headercs = "<h3>&nbsp;</h3><h3>NOVOSTAVBA PAVILONU PRO PACIENTY S ALZHEIMEROVOU CHOROBOU DOMOVA PRO SENIORY RADKOVA LHOTA</h3>";
		
$textcs = "	<div class='detail'>
	<div>místo stavby <span class='red'>|</span> Radkova Lhota</div>
