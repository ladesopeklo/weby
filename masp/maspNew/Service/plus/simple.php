...
// client id, client secret, and to register your redirect uri.
 $client->setClientId('19888929621-9fhsprfeeaiclt42k8oomadlv7en6874.apps.googleusercontent.com');
 $client->setClientSecret('IJUwAPqlE8J0N6g4cm565HZg');
 $client->setRedirectUri('http://localhost:85/weby/masp/maspnew/service/plus/simple.php');
 $client->setDeveloperKey('19888929621-9fhsprfeeaiclt42k8oomadlv7en6874@developer.gserviceaccount.com');
